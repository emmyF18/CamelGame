...
namespace Camel_Game
{
    class Program
    {
        ...
        private static int thirst = 0;
        private static int camelTiredness = 0;
        private static int nativeDistance = -20;
        private static int drinksLeft = 3;
        private static bool isDone = false;
        static void Main(string[] args)
        {
            RunCamelGame();
        }
        public static void RunCamelGame()
        {
            milesTraveled = 0;
            thirst = 0;
            camelTiredness = 0;
        ...
        private static void Ahead(string speed)
        {
            Random random = new Random();
